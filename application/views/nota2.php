...
<div class="content">		
	    ...
	    <div class="card">
			<div class="col-md-9"></div><a class="btn btn-danger" href="<?php echo site_url();?>/Dashboard"> Home <i class="fa fa-home"></i> </a>	<a class="btn btn-primary hidden-print" onclick="javascript:window.print();">
